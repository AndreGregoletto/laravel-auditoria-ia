# AUD-055 — Settings / Register / File Step / Edit

## Header
- **Screen:** Settings / Register / File Step / Edit
- **Objective:** edit an existing File Step.
...
## Overview
This screen updates an existing File Step record. Fields are pre-filled.
...
### AUD-055-RN-01 — Required fields
Name and name_conf cannot be empty.

### AUD-055-RN-02 — Conditional uniqueness
...
## Audit & Logs
- Recommended event: `FILE_STEP_UPDATED`
