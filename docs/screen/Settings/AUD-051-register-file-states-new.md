# AUD-057 — Settings / Register / File States / New

## Header
- **Screen:** Settings / Register / File States / New
- **Objective:** create a new File States.
...
### AUD-057-RN-01 — Required fields
Name and name_conf are mandatory.

### AUD-057-RN-02 — Uniqueness
Both Name and name_conf must be unique.

### AUD-057-RN-03 — Default status
...
## Audit & Logs
- Recommended event: `FILE_STATUS_CREATED`
