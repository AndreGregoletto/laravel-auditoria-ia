# AUD-022 — Reports / Company / Company Tree

## Header
- **Screen:** Reports / Company / Company Tree
- **Objective:** list all active company trees in the system and allow navigation to tree reports or organizational charts.
...
## Flow
### Entry
- User accesses **Reports / Company / Company Tree**.
