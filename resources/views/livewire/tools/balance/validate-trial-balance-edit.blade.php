        ...
        <div class="flex flex-col gap-2 sm:items-end">
            <div class="text-sm text-gray-600 dark:text-gray-300">
                <span class="font-medium text-gray-900 dark:text-gray-100">
                    {{ $file->company->comercial_name ?? $file->company->name }}
                </span>
            </div>

            <div class="flex flex-wrap items-center justify-end gap-2">
                <div class="inline-flex max-w-full items-center gap-2 rounded-lg border border-gray-200 bg-white
                    px-3 py-2 text-sm text-gray-700 shadow-sm dark:border-gray-800 dark:bg-gray-950 dark:text-gray-200"
                >
                    ...
                    <span class="truncate max-w-[42vw] sm:max-w-[360px]">{{ $file->file_name }}</span>
