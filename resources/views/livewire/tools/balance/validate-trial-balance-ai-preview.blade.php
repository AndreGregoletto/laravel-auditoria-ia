<x-slot name="header">
    <div class="flex items-center justify-between gap-3">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('navbar.tools') }} / {{ __('navbar.processes') }} / {{ __('navbar.validate_bal') }} / AI Preview
        </h2>
...
<div class="py-6 space-y-5">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
            ...
            <div class="lg:col-span-3">
                ...
                <select wire:model.live="filter"
                    ...
                    <option value="included">Sugeridas incluídas</option>
                    <option value="excluded">Sugeridas excluídas</option>
                    <option value="changed">Alteradas pelo auditor</option>
                    <option value="low_confidence">Baixa confiança</option>
                </select>
            </div>

            <div class="lg:col-span-2">
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-200">Min. confiança</label>
    ...
    <div class="rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
        ...
        <div class="grid grid-cols-1 gap-3 lg:grid-cols-3">
            <div>
                <div class="text-xs text-gray-500 dark:text-gray-400">Soma saldo final (arquivo)</div>
            ...
            <div>
                <div class="text-xs text-gray-500 dark:text-gray-400">Soma saldo final (incluídas na prévia IA)</div>
            ...
            <div>
                <div class="text-xs text-gray-500 dark:text-gray-400">Diferença (prévia - arquivo)</div>
        ...
        <div class="max-h-[calc(100vh-260px)] overflow-auto">
            <table class="min-w-full text-sm">
                ...
                <tr class="text-left text-xs font-semibold text-gray-600 dark:text-gray-300">
                    ...
                    <th class="px-3 py-2 text-right">Saldo final</th>
                    <th class="px-3 py-2 text-center">Sugestão IA</th>
                    <th class="px-3 py-2">Racional</th>
                ...
                @foreach($rows as $r)
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-950/40">
                        ...
                        <td class="px-3 py-2 text-center">
                            @if($effective === true)
                                <span class="inline-flex rounded-full bg-emerald-100 px-2 py-1 text-xs font-semibold text-emerald-700 dark:bg-emerald-900/40 dark:text-emerald-200">Incluir</span>
                            @elseif($effective === false)
                                <span class="inline-flex rounded-full bg-rose-100 px-2 py-1 text-xs font-semibold text-rose-700 dark:bg-rose-900/40 dark:text-rose-200">Excluir</span>
                            @else
