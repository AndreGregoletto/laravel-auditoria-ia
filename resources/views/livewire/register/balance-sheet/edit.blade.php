<x-slot name="header">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">
            {{ __('navbar.settings') }} / {{ __('navbar.register') }} / {{ __('reports.bp_classification') }} / {{ __('navbar.edit') }}
        </h1>
    </div>
</x-slot>
    ...
    <form wire:submit="save" class="space-y-6">
        <div class="grid gap-3 grid-cols-1 md:grid-cols-4">
            ...
            <div>
                ...
                <select wire:model="form.side" class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">
                    <option>{{ __('labels.select') }}</option>
            ...
            <div>
                ...
                <select wire:model="form.section" class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100">
                    <option>{{ __('labels.select') }}</option>
