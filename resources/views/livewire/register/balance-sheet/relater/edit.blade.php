        ...
        <form wire:submit="save" class="space-y-6">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-4">
                <div>
                    ...
                    <input
                        type="text"
                        value="{{ $form['company_tree_id'] ?: '' }}"
                        disabled
                        class="w-full rounded-lg border border-gray-300 bg-gray-100 px-3 py-2 text-sm text-gray-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300"
                    />
                </div>
            ...
            <div class="flex gap-3">
                ...
                <a
                    href="{{ route('settings.register.asset-base-classification.index') }}"
