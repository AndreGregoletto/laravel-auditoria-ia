<x-slot name="header">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">
            {{ __('navbar.settings') }} / {{ __('navbar.register') }} / {{ __('reports.destination_service') }} / {{ __('navbar.consult') }}
        </h1>
    </div>
</x-slot>
...
<div class="space-y-6 py-12">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('settings.register.destination-service.create') }}"
        ...
        <table class="w-full table-fixed divide-y divide-gray-200 dark:divide-gray-800">
            ...
            @forelse($response as $res)
                ...
                >
                    ...
                    <td class="px-4 py-3">
                        <a href="{{ route('settings.register.destination-service.edit', $res->id) }}"
