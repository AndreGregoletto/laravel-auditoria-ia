<x-slot name="header">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100">
            {{ __('navbar.settings') }} / {{ __('navbar.register') }} / {{ __('reports.file_step') }} / {{ __('navbar.new') }}
        </h1>
    </div>
</x-slot>
...
<div class="space-y-6 py-12">
    <form wire:submit="save" class="space-y-6">
        <div class="grid gap-4 grid-cols-1 md:grid-cols-3">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __("reports.name_conf") }} <span class="text-red-600">*</span></label>
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('settings.register.file-step.index') }}"
