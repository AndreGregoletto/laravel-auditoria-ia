            ...
            <ul class="pc-navbar">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <ul class="pc-submenu">
                        ...
                        <li class="pc-item pc-hasmenu">
                            <a href="#!" class="pc-link">
                                <span class="pc-mtext">{{ __('reports.file_states') }}</span>
                                <span class="pc-arrow"><i class="ti ti-chevron-right"></i></span>
                            </a>

                            <ul class="pc-submenu">
                                <li class="pc-item">
                                    <a class="pc-link" href="{{ route('settings.register.file-status.index') }}">
                                        {{ __('navbar.consult') }}
                                    </a>
                                </li>

                                <li class="pc-item">
                                    <a class="pc-link" href="{{ route('settings.register.file-status.create') }}">
                                        {{ __('navbar.new') }}
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="pc-item pc-hasmenu">
                            <a href="#!" class="pc-link">
                                <span class="pc-mtext">{{ __('reports.file_step') }}</span>
                                <span class="pc-arrow"><i class="ti ti-chevron-right"></i></span>
                            </a>

                            <ul class="pc-submenu">
                                <li class="pc-item">
                                    <a class="pc-link" href="{{ route('settings.register.file-step.index') }}">
                                        {{ __('navbar.consult') }}
                                    </a>
                                </li>
